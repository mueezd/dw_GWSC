...
if (isset($_POST['add'])) {
    ...
    if ($image_size > 2000000) {
        ...
        $add_pitch = $conn->prepare("INSERT INTO `pitch`(id, name, price, image) VALUES(?,?,?,?)");
        $add_pitch->execute([$id, $name, $price, $rename]);
